...
# @Last Modified time: 2019-07-30 02:38:53
# @==========explanation========
# @inputs:
...
#!/bin/sh
echo "Fz_Gal80_s24r1_summary.csv, 1, 1, 24, 18, 40, 20, 2" | /netapp/home/wji/anaconda3/bin/python3 /awlab/projects/2015_07_Neural_Superposition/Projects/Weiyue/Code/python_cluster/main_functions/Data_quantification_main.py
