...
# @scale_factor = input_list[7] = rfp/gfp# @channels_type = input[11] - 'R3R4' or 'FasII' 
 ...
 #!/bin/sh 
echo "Euclid, Figure_output_v0404, Data_output_v0404, Ctrl_26hrs_Gal80_s1r1_annotation.csv, 0, 1, 30, 30, 50, 20, 0.89, R3R4" | /wynton/home/awlab/wji/anaconda3/bin/python3 /awlab/projects/2019_09_NSP_Extension/code/NSP_extension/python/python_cluster/main/data_quantification_main_v040100.py
qstat -j $JOB_ID