...
# @Last Modified time: 2020-03-30 12:55:04
# @==========explanation========
# @inputs:
# @env = input_list[0]
...
#!/bin/sh
echo "Euclid, FigureOutput_v033020, DataOutput_v033020, Ctrl_24hrs_Gal80_s4r102_annotation.csv, 0, 1, 24, 18, 50, 20, 0.9" | /wynton/home/awlab/wji/anaconda3/bin/python3 /awlab/projects/2019_09_NSP_Extension/code/NSP_extension/python/python_cluster/main_functions/data_quantification_main_v0927.py
