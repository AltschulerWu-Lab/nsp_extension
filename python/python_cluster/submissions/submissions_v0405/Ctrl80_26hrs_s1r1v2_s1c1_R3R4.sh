...
# @scale_factor = input_list[7] = rfp/gfp# @channels_type = input[11] - 'R3R4' or 'FasII' 
 ...
 #!/bin/sh 
echo "Euclid, Figure_output_v0405, Data_output_v0405, Ctrl_26hrs_Gal80_s1r1_annotation.csv, 1, 1, 10, 6, 10, 2, 0.89, R3R4" | /wynton/home/awlab/wji/anaconda3/bin/python3 /awlab/projects/2019_09_NSP_Extension/code/NSP_extension/python/python_cluster/main/data_quantification_main_v040502.py
qstat -j $JOB_ID