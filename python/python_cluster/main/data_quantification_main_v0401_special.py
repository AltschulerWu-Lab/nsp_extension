...
# @Last Modified time: 2020-04-02 12:27:44
...
def save_results(annot_bundles_df, intensity_matrix, params, rel_points):
	...
	output_name = f'{category_id}_sample{sample_id}_region{region_id}_slice{analysis_params_general.slice_type}_center{analysis_params_general.center_type}_{channels_type}_v{date_info}_02.pickle'
