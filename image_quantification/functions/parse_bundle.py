...
# @Last Modified time: 2020-07-15 17:09:04
...
def get_bundles_info_v3(roi_df, annot_df, x_ratio, y_ratio, **kwargs):
	### unravel kwargs
...
### get bundle information Version 4: 7 points or 1 ellipse per ROI. 
### - 7 points: Heel bundle w/ R1-R6 and bundle center
### - Ellipse: target ellipse.
def get_bundles_info_v4(roi_df, annot_df, x_ratio, y_ratio, **kwargs):
	### unravel kwargs
	if('is_print' in kwargs.keys()):
		is_print = kwargs['is_print']
	else:
...
- columns: 'AgeID', 'CategoryID', 'Orientation_AP', 'Orientation_DV', 'RegionID',
	   ...
	   'TargetNo_T2', 'TargetNo_T7'
"""
def get_bundles_info_v3_old(roi_df, annot_df, x_ratio, y_ratio, is_extended_target_list):
	### initialization
	r_coords_list = []
	for i in range(6):
		for j in ['X', 'Y', 'Z']:
